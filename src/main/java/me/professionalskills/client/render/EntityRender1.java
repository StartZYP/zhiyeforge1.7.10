...
public class EntityRender1 extends Render {
    ...
    public static void Cylinder(float radius, float height, float alpha) {
        if (alpha == 1)
            GL11.glColor4d(0.6862745098039216, 0.9333333333333333, 0.9333333333333333, alpha);
        else
            GL11.glColor4d(0.6862745098039216, 0.9333333333333333, 0.9333333333333333, alpha);
...
//        System.out.println("222" + x2 + ";" + y2 + ";" + z2);
        try {
            ...
            Cylinder(0.06F, distance, 1F);
            Cylinder(0.075F, distance, 0.1001F);
            Cylinder(0.085F, distance, 0.1001F);
            Cylinder(0.9F, distance, 0.1001F);
            GL11.glPopMatrix();
        } catch (Exception e) {
