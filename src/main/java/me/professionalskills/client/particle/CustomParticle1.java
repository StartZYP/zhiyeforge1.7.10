...
import me.professionalskills.client.render.EntityRender1;
...
public class CustomParticle1 extends EntityFX {
    ...
    public CustomParticle1(World worldIn, double posXIn, double posYIn, double posZIn, EntityLivingBase player) {
